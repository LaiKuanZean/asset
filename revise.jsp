                ...
                <form method="post" action="updateproduct.jsp">
                    <h2>── 📝修改資料 ──</h2>
                        <table class="revise_content">
                            ...
                            <tr>
                                <td class="left">產品編號 : <input required type="text" class="data" name="IDproduct" value="<%=IDproduct%>"/></td>
                                <td>產品名稱 : <input required type="text" class="data" name="NameProduct" value="<%=NameProduct%>" /></td>
                            </tr>

                            <tr>
                                <td class="left">顏色 : <input required type="text" class="data" name="Color" value="<%=Color%>" /></td>
                                <td>價錢 : <input required type="text" class="data" name="Price" value="<%=Price%>" /></td>
                            </tr>

                            <tr>
                                <td class="left">庫存 : <input required type="text" class="data" name="Left" value="<%=Left%>" /></td>
                            </tr>
                        </table>
