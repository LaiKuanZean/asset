        ...
        <div class="goodslide">
          <div class="goodpic">
            ...
            <!--<div class="mySlides">
              ...
              <img src="photo/pri-ash.jpg" style="width: 600px">
            </div>

            <div class="mySlides">
              <div class="numbertext">2 / 4</div>
              <img src="photo/pri-green.jpg" style="width: 600px">
            </div>

            <div class="mySlides">
              <div class="numbertext">3 / 4</div>
              <img src="photo/pri-red.jpg" style="width: 600px">
            </div>

            <div class="mySlides">
                <div class="numbertext">4 / 4</div>
                <img src="photo/pri-white.jpg" style="width: 600px">
              </div>-->
		  ...
		  <% 
				...
				%>	
            <!--<div class="column">
              <img class="demo cursor" src="photo/pri-ash.jpg" style="width:100%" onclick="currentSlide(1)">
            </div>
            <div class="column">
              <img class="demo cursor" src="photo/pri-green.jpg" style="width:100%" onclick="currentSlide(2)">
            </div>
            <div class="column">
              <img class="demo cursor" src="photo/pri-red.jpg" style="width:100%" onclick="currentSlide(3)">
            </div>
            <div class="column">
                <img class="demo cursor" src="photo/pri-white.jpg" style="width:100%" onclick="currentSlide(4)">
              </div>-->
          </div>
        </div>
      </div>
        ...
        <h4>車款介紹</h4>
          <div class="introduce">
            ...
            <div id="info" class="tabcontent">
                ...
                與時俱進的移動美學，經典風格萬人迷<br>
                Vespa Primavera 150 i-get ABS 全新歐盟五期(Euro 5)環保新車，<br>
                符合台灣七期環保法規，新增引擎熄火開關、車輛傾倒感知器、排氣管前端防燙蓋等多項升級功能，<br>
                使新車內外兼具；搭載四行程i-get引擎，展現高效能低油耗量的特性，<br>
                並採用12吋五輻鋁合金輪圈，配備上LED頭尾燈與日行燈、晶片防盜系統，<br>
                與ABS 防鎖死煞車系統，提高整體行車穩定度及防護安全性，提供騎士更加平穩順暢、<br>
                舒適無慮的騎乘體驗。在外觀設計上，Primavera 車系具備高識別的圓型頭燈、<br>
                堅固的鋼製車身，與充滿曲線魅力的車身線條，成為風靡超過50年、世上最經典的兩輪速克達象徵。<br>
                加上車前獨特的「V型領結飾蓋」和前土除上的凸起鉻飾，展現優雅時尚質感。<br>
              </div>
